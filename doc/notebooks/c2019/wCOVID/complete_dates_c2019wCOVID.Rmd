...
##Modifying the lenght of variable labels
The maximum number of characters that stata allows in its labels in version 13 
is 80 characters. That is why we need to modify the width of the labels to this
...
# Run comparison (x2) - se compara la versión modificada sin errores con la versión modificada por demométrica
