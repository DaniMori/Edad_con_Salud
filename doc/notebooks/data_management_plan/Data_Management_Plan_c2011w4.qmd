...
VERSION_HISTORY <- tibble(
  ...
  Contributors             = list(c("Aina Gabarrell", "Blanca Dolz")),
  Reviewers                = list(
    c(
      "Aina Gabarrell", "Beatriz Olaya", "Blanca Dolz", "Cristina Rodriguez",
      "Joan Doménech", "Lea Francia", "Marta Miret"
    )
  ),
  `Version nº`             = c("0.0", "0.0.1", "0.1.0"),
  Name                     = c(
    "Borrador inicial",
    "Correcciones sobre el borrador inicial",
    "Actualización de roles y proceso de actualización de datos"
  ),
  Date                     = c(
    "25-11-2022",
    "08-02-2023",
  ...
  `Change description`     = list(
    ...
    c(
      "Corrige indentación en sintaxis de Stata",
      "Elimina el rol de acceso _data owner_",
      paste(
        "Actualiza proceso de actualización de los datasets, incluyendo",
        "_notificación_ a todos los miembros mediante mención de canal"
      )
    )
  )
)
...
current_version                                                    |>
  ...
  mutate(
    Reviewers    = Reviewers    |> map_chr(paste, collapse = ', '),
    Contributors = Contributors |> map_chr(paste, collapse = ', ')
  )                                                                |>
