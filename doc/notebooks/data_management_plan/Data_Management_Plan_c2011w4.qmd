...
VERSION_HISTORY <- tibble(
  ...
  Reviewers                = list(
    "Blanca Dolz",
    c("Blanca Dolz", "Aina Gabarrell")
  ),
  `Version nº`             = c("0.0", "0.0.1"),
  Name                     = c(
    "Borrador inicial",
    "Correcciones sobre el borrador inicial"
  ),
  Date                     = c(
    "25-11-2022",
    "08-02-2023"
  ...
  `Change description`     = list(
    ...
    c(
      "Corrige erratas",
      "Cambia referencia temporal en el nombre de archivos históricos por _CET_"
    )
  )
)
...
current_version                                                    |>
  ...
  mutate(Reviewers = Reviewers |> map_chr(paste, collapse = ', ')) |>
