...
ex_mig_date_formatted <- EXAMPLE_MIG_DATE |> as.character()
...
OUTPUT_TEST_DIR <- file.path("~/../OneDrive - UAM/Migration_TEST") |>
...
master_db_filename <- "C2019W1_rawdata"
...
```{r}
complete_db |> write_dta(path = complete_db_file_out)
```
...
- `Bases de datos maestras Edad con Salud/Ola_3/Cohorte_2019/history/snapshot_`r ex_mig_date_formatted`.dta`
