...
HISTORY_OLD_DIR <- file.path(C2019W1_DIR, HISTORY_OLD_SUBDIR)
...
# History directory:
result <- file.rename(HISTORY_OLD_DIR, HISTORY_DB_DIR_OUT)
if (!result) {
...
```{r process-duplicated-versions-exec, ref.label="process-duplicated-versions"}
# TODO: Delete chunk content
unlink(PRECOVID_DB_FILE_OLD) # Delete Stata 14 version
