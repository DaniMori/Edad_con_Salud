...
contact_data               |>
  ...
  ungroup()                |>
  filter(occurences > 1)   |>
  select(!!ID_VAR, !!name_sym, !!surname_sym)
```
...
```{r returned-letters}
## TODO: Compare with the information from the returned letters
```
